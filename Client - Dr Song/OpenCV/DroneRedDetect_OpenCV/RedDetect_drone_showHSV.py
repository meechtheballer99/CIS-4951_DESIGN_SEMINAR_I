...
while True:
    ...
    for contour in maskContours:
        ...
        # Get HSV value of pixel at centroid position
        hsv_value = hsv[centroid_y, centroid_x]
        hsv_text = "HSV: {}".format(hsv_value)
    
        # Display HSV value on frame
        cv2.putText(final, hsv_text, (x,y-20), font, 1, (255,255,255), 2)
